...
/**
* Register post type for books
*/
function book_custom_post_init() {
    
	// set up book post type labels
    $labels = array(
        'name' => 'Book',
        'singular_name' => 'Book',
...
add_action( 'init', 'book_custom_post_init' );

/**
 * Register meta box(es) for book meta fields.
 */
function books_register_meta_boxes() {
    add_meta_box( 'meta-box-id', __( 'Books Details', 'textdomain' ), 'books_display_custom_fields_callback', 'books' );
}
add_action( 'add_meta_boxes', 'books_register_meta_boxes' );
 
/**
 * Meta box display callback for book custom fields.
 */
function books_display_custom_fields_callback( $post ) {
	$book_author = get_post_meta( get_the_ID(), 'book_author', true );
	$number_of_copies = get_post_meta( get_the_ID(), 'number_of_copies', true );
    ...
    ?>
		...
		<p>
			...
			<input type="number" name="number_of_copies" value="<?php echo $number_of_copies; ?>">
		</p>
